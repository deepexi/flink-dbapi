...
from flink_api.flink_sql_parser import FlinkSqlParseHelper, FLINK_SQL_TYPE_SET, FLINK_SQL_TYPE_USE, FLINK_SQL_TYPE_SHOW, \
    FLINK_SQL_TYPE_DROP, FLINK_SQL_TYPE_CREATE_CATALOG, FLINK_SQL_TYPE_CREATE_DATABASE, FLINK_SQL_TYPE_CREATE_TABLE, \
    FLINK_SQL_TYPE_CREATE_VIEW, FLINK_SQL_TYPE_SELECT, FLINK_SQL_TYPE_DESCRIBE, FLINK_SQL_TYPE_INSERT, \
...
class TestFlinkSqlTypeHelper(unittest.TestCase):
    ...
    def test_sql_type_verdict_simple(self):
        ...
        #
        self.assertEquals(FLINK_SQL_TYPE_CREATE_CATALOG, FlinkSqlParseHelper.sql_type_verdict("create catalog cat1"))
        self.assertEquals(FLINK_SQL_TYPE_CREATE_DATABASE,
                          FlinkSqlParseHelper.sql_type_verdict("create database c1.db1"))
        self.assertEquals(FLINK_SQL_TYPE_CREATE_DATABASE, FlinkSqlParseHelper.sql_type_verdict("create database db1"))
        #
